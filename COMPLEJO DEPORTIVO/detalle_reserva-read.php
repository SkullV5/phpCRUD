...
if (isset($_GET["reserva_cod_reserva"]) && !empty($_GET["reserva_cod_reserva"])) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        // Set parameters
        $param_id = trim($_GET["reserva_cod_reserva"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>ID</h4>
                            <p class="form-control-static"><?php echo $row["cancha_cod_cancha"]; ?></p>
                        </div><div class="form-group">
                            <h4>Cod. de reserva</h4>
                            <p class="form-control-static"><?php echo $row["reserva_cod_reserva"]; ?></p>
                        </div><div class="form-group">
                            <h4>Cantidad</h4>
                    ...
                    <p><a href="detalle_reserva-index.php" class="btn btn-primary">Volver</a></p>
                </div>
            </div>
        </div>
    </section>
